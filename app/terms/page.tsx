      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div>
            ...
            <p className="text-sm">
              Η πρόσβαση και η περιήγηση στον ιστότοπο <strong>Artistic Lens Photography</strong> προϋποθέτει την πλήρη και ανεπιφύλακτη αποδοχή των παρόντων όρων χρήσης. Εάν δεν συμφωνείτε με τους όρους αυτούς, παρακαλούμε να μην χρησιμοποιήσετε την ιστοσελίδα.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-sm mb-3">
              Όλο το φωτογραφικό υλικό, τα κείμενα, τα γραφικά, τα λογότυπα και η γενική διάταξη της ιστοσελίδας αποτελούν πνευματική ιδιοκτησία του <strong>Artistic Lens Photography</strong> και προστατεύονται από την ελληνική και ευρωπαϊκή νομοθεσία περί πνευματικών δικαιωμάτων.
            </p>
