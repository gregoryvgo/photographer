      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div>
            ...
            <p className="text-sm">
              Στο <strong>Photgraphy Lensium</strong>, σεβόμαστε απόλυτα την ιδιωτικότητά σας και δεσμευόμαστε να προστατεύουμε τα προσωπικά δεδομένα που μοιράζεστε μαζί μας, σε πλήρη συμμόρφωση με τον Γενικό Κανονισμό Προστασίας Δεδομένων (GDPR - ΕΕ 2016/679).
            </p>
          </div>
